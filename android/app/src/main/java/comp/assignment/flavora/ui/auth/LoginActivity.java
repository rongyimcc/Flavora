 ...
 * <p>功能描述：</p>
 * <ul>
 *   <li>提供用户登录表单，包含邮箱和密码输入框</li>
 *   <li>验证用户输入的合法性（邮箱格式、密码长度等）</li>
 *   <li>通过AuthRepository与后端进行身份验证</li>
 *   <li>登录成功后跳转到主界面</li>
 *   <li>提供跳转到注册界面的入口</li>
 * </ul>
 *
 ...
 *   <li>使用Task异步处理登录请求</li>
 *   <li>在登录过程中显示加载状态，禁用输入</li>
...
public class LoginActivity extends AppCompatActivity {
     ...
     *   <li>获取用户输入的邮箱和密码</li>
     *   <li>验证输入数据的合法性</li>
     *   <li>如果验证通过，调用AuthRepository执行登录</li>
     *   <li>根据登录结果跳转到主界面或显示错误信息</li>
     * </ol>
     *
     * <p>验证规则：</p>
     * <ul>
     ...
     * </ul>
     *
     * <p>此方法用于在登录请求过程中防止用户重复提交或修改输入。</p>
     *
     ...
     * 跳转到注册界面
     *
     * <p>当用户点击"注册"链接时调用此方法，打开注册Activity。</p>
     */
     ...
     * 跳转到主界面并清除返回栈
     *
     * <p>登录成功后调用此方法，跳转到应用主界面。使用特殊的Intent标志
     * 清除所有之前的Activity，防止用户通过返回键返回到登录界面。</p>
     *
     * <p>使用的Intent标志：</p>
     * <ul>
